...
const PROJECT_FACES: ProjectFace[] = [
  ...
  },
  {
    ...
    category: 'Computer Vision & AI Ingestion',
    tagline: 'Deconstructing physical paper receipts into structured JSON line-items.',
    stack: ['Gemini OCR', 'Confidence Engine', 'Image Processing'],
  ...
  },
  {
    ...
    category: 'Production Cross-Platform Stack',
    tagline: 'Native performance, 60fps animations & offline-first local persistence.',
    stack: ['React Native 0.86', 'Reanimated 4', 'Supabase', 'TypeScript'],
